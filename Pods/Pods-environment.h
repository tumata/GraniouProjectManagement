...
// MCViewFactory
#define COCOAPODS_POD_AVAILABLE_MCViewFactory
#define COCOAPODS_VERSION_MAJOR_MCViewFactory 0
#define COCOAPODS_VERSION_MINOR_MCViewFactory 0
#define COCOAPODS_VERSION_PATCH_MCViewFactory 9
